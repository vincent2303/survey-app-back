const mail = function (token, user) {
  return `<br /><br />
...
@media only screen and (min-width:768px){
  ...
  #templateFooter .mcnTextContent,#templateFooter .mcnTextContent p{
      ...
      line-height:150% !important;
          ...
          When you're ready to answer the survey just click on the following <a href="http://localhost:3000/sondage/?token=${token}">
          link
          </a> It will send you to the survey page already authentified as: ${user.firstName} ${user.lastName}</p>
